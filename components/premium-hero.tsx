    ...
    <section className="relative overflow-hidden bg-background">
      ...
      <div className="container-tight relative">
        ...
        <div className="mx-auto max-w-3xl pt-16 text-center md:pt-24">
          <motion.span
            {...rise(0)}
            className="inline-flex items-center gap-2 rounded-full border border-stone/70 bg-paper/70 px-4 py-1.5 text-[12px] font-medium uppercase tracking-[0.16em] text-graphite backdrop-blur"
          >
            <ShieldCheck className="h-3.5 w-3.5 text-brand-600" />
            Insured &amp; bonded · Salt Lake County
          </motion.span>

          <motion.h1 {...rise(0.08)} className="mt-7 text-balance display-1 text-charcoal">
            A cleaner home.
          ...
          <motion.p
            {...rise(0.16)}
            className="mx-auto mt-6 max-w-xl text-pretty text-lg leading-relaxed text-graphite md:text-xl"
          >
          ...
          <motion.p {...rise(0.32)} className="mt-6 text-sm text-graphite/80">
