-- ClearNest — complete database setup. Paste ALL of this into the Supabase SQL Editor and Run.
-- Safe to re-run (idempotent). Order matters: 0001 → 0002 → 0003.
...
-- ============================================================
-- 0002 — phase 2 (invoices, owner-scoped access)
-- ============================================================
...
-- ============================================================
-- Add Google review link setting (for the 'Request review' button)
-- ============================================================
insert into public.site_settings (key, value) values ('google_review_url','') on conflict (key) do nothing;
